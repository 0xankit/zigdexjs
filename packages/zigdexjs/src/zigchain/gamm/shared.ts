...
export interface MigrationRecordsProtoMsg {
  typeUrl: "/zigchain.gamm.MigrationRecords";
  value: Uint8Array;
}
/**
 * MigrationRecords contains all the links between balancer and concentrated
...
export interface MigrationRecordsAminoMsg {
  type: "/zigchain.gamm.MigrationRecords";
...
export interface BalancerToConcentratedPoolLinkProtoMsg {
  typeUrl: "/zigchain.gamm.BalancerToConcentratedPoolLink";
  value: Uint8Array;
}
/**
 * BalancerToConcentratedPoolLink defines a single link between a single
...
export interface BalancerToConcentratedPoolLinkAminoMsg {
  type: "/zigchain.gamm.BalancerToConcentratedPoolLink";
