...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    zigchain: {
      ...
      factory: (await import("./factory/query.rpc.Query")).createRpcQueryExtension(client),
      gamm: (await import("./gamm/query.rpc.Query")).createRpcQueryExtension(client),
      poolmanager: (await import("./poolmanager/query.rpc.Query")).createRpcQueryExtension(client),
      twap: (await import("./twap/query.rpc.Query")).createRpcQueryExtension(client)
    }
  };
};