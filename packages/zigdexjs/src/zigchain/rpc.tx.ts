...
export const createRPCMsgClient = async ({
  ...
  zigchain: {
    ...
    factory: new (await import("./factory/tx.rpc.msg")).MsgClientImpl(rpc),
    gamm: new (await import("./gamm/tx.rpc.msg")).MsgClientImpl(rpc),
    poolmanager: new (await import("./poolmanager/tx.rpc.msg")).MsgClientImpl(rpc),
    twap: new (await import("./twap/tx.rpc.msg")).MsgClientImpl(rpc)
  }
});