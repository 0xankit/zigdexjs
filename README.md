...
<p align="center">
  <img src="https://user-images.githubusercontent.com/545047/188804067-28e67e5e-0214-4449-ab04-2e0c564a6885.svg" width="80"><br />
    An SDK to interact with zigchain
</p>

<p align="center" width="100%">
  <a href="https://github.com/0xankit/zigdexjs/actions/workflows/run-tests.yml">
    <img height="20" src="https://github.com/0xankit/zigdexjs/actions/workflows/run-tests.yml/badge.svg" />
  </a>
   <a href="https://github.com/0xankit/zigdexjs/blob/main/LICENSE"><img height="20" src="https://img.shields.io/badge/license-MIT-blue.svg"></a>
</p>
...
const balance = await client.cosmos.bank.v1beta1
    .allBalances({ address: 'zigchain1addresshere' });

// you can also query the zigchain modules
const balances = await client.zigchain.exchange.v1beta1
    .exchangeBalances()
```

### Composing Messages

Import the `zigchain` object from `zigdexjs`. 
...
const {
    ...
    deposit
} = zigchain.exchange.v1beta1.MessageComposer.withTypeUrl;
```

#### CosmWasm Messages

```js
import { cosmwasm } from "zigdexjs";
...
```js
import { getSigningZigchainClient } from 'zigdexjs';
...
Look inside of `scripts/codegen.ts` and configure the settings for bundling your SDK and contracts into `zigdexjs`:
